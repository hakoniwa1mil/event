...
作り方:
- 入力全体(最近の挑戦・ふとした瞬間に考えていること)から、本人がこのイベントで何を持ち帰りたいか・何を目指しているかを見つける
...
3. overthinkLine: 「ふとした瞬間に「◯◯」を考えています」の形。本人が普段気になっていること・迷っていることを短い言葉に凝縮する
...
export async function POST(req: Request) {
  ...
  const challengeOverthinkSection =
    input.mode === "ai"
      ? `## 普段使っているAIに聞いた回答 (最近の挑戦・ふとした瞬間に考えていることを含む)
${input.aiRaw || "(未入力)"}`
